...
这是 2026 年6月 2 日生成的管道图，有意思，第一次创建。
    ...
    ║      📡 输入源（不设限，随手记）                        ║
    ║                                                     ║
    ║   📖 书籍（微信读书）  🎬 视频（YouTube·抖音）        ║
    ║   🎧 播客              📰 文章（公众号·博客）          ║
    ║   🚶 日常观察·散步灵感   🗣️ 朋友·同事交流               ║
    ║                                                     ║
    ║   输入工具：Flomo → 微信语音 → Typeless → 键盘        ║
    ║           随便哪个，终点都是同一个                      ║
    ║                      ↓                               ║
    ║             ┌──────────────────┐                     ║
    ║             │    内容池（素材）   │                     ║
    ...
    ║          │                   │                        ║
    ║          ▼                   ▼                        ║
    ║     🌐 liaodingjiu.com    🎬 抖音 · 视频号             ║
    ║                                                     ║
    ║   ┌──────────────────────────────────────────┐      ║
    ║   │      🧩 副产物                              │      ║
    ║   │  灵感/洞见卡  金句库（234条）  知识卡片       │      ║
    ║   │  金句创意图  知识卡片图（模板→即梦/可灵）    │      ║
    ║   └──────────────────────────────────────────┘      ║
    ║                                                     ║
    ...
    现在全了：
    - 信息源 6 类，不设限，碰到让你兴奋的就记
    - 输入工具 4 种，随便换，终点是同一个文件
    - 双工作台 A/B，你选今天坐哪个台前
    - 出口 3 个（网站 + 抖音 + 视频号）
    - 副产物 5 种，创作中自然生长
